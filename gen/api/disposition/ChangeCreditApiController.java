...
public class ChangeCreditApiController implements ChangeCreditApi {

    private final ChangeCreditApiDelegate delegate;

    public ChangeCreditApiController(@Autowired(required = false) ChangeCreditApiDelegate delegate) {
        this.delegate = Optional.ofNullable(delegate).orElse(new ChangeCreditApiDelegate() {});
    }

    @Override
    public ChangeCreditApiDelegate getDelegate() {
        return delegate;
    }
