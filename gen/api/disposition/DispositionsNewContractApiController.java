...
public class DispositionsNewContractApiController implements DispositionsNewContractApi {

    private final DispositionsNewContractApiDelegate delegate;

    public DispositionsNewContractApiController(@Autowired(required = false) DispositionsNewContractApiDelegate delegate) {
        this.delegate = Optional.ofNullable(delegate).orElse(new DispositionsNewContractApiDelegate() {});
    }

    @Override
    public DispositionsNewContractApiDelegate getDelegate() {
        return delegate;
    }
