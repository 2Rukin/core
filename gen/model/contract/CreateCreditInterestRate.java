...
/**
 * CreateCreditInterestRate
 */

@JsonTypeName("createCreditInterestRate")
/**
 * DTO CreateCreditInterestRate.
 *
 * @author GPT-5.2-Codex
 */
@Data
@Builder
public class CreateCreditInterestRate {
  ...
  public CreateCreditInterestRate limits(List<UUID> limits) {
    this.limits = limits;
    return this;
  }

  public CreateCreditInterestRate addLimitsItem(UUID limitsItem) {
    if (this.limits == null) {
  ...
  */
  ...
  public CreateCreditInterestRate kind(InterestRateKind kind) {
    this.kind = kind;
    return this;
  }
  ...
  */
  ...
  public CreateCreditInterestRate type(InterestRateType type) {
    this.type = type;
    return this;
  }
  ...
  */
  ...
  public CreateCreditInterestRate dateFrom(String dateFrom) {
  ...
  */
  ...
  public CreateCreditInterestRate dateTo(String dateTo) {
    this.dateTo = dateTo;
    return this;
  }
  ...
  */
  ...
  public CreateCreditInterestRate value(String value) {
    this.value = value;
    return this;
  }
  ...
  */
  ...
  public CreateCreditInterestRate uuid(UUID uuid) {
    this.uuid = uuid;
    return this;
  }
  ...
  */
  ...
  public CreateCreditInterestRate components(List<@Valid CreateInterestRateComponent> components) {
    this.components = components;
    return this;
  }

  public CreateCreditInterestRate addComponentsItem(CreateInterestRateComponent componentsItem) {
  ...
  */
  ...
  public CreateCreditInterestRate base(InterestRateBase base) {
    this.base = base;
    return this;
  }
  ...
  */
  ...
  public CreateCreditInterestRate basePeriod(InterestRateBasePeriod basePeriod) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    CreateCreditInterestRate createCreditInterestRate = (CreateCreditInterestRate) o;
    return Objects.equals(this.limits, createCreditInterestRate.limits) &&
        Objects.equals(this.kind, createCreditInterestRate.kind) &&
        Objects.equals(this.type, createCreditInterestRate.type) &&
        Objects.equals(this.dateFrom, createCreditInterestRate.dateFrom) &&
        Objects.equals(this.dateTo, createCreditInterestRate.dateTo) &&
        Objects.equals(this.value, createCreditInterestRate.value) &&
        Objects.equals(this.uuid, createCreditInterestRate.uuid) &&
        Objects.equals(this.components, createCreditInterestRate.components) &&
        Objects.equals(this.base, createCreditInterestRate.base) &&
        Objects.equals(this.basePeriod, createCreditInterestRate.basePeriod);
  }

  @Override
  public int hashCode() {
    return Objects.hash(limits, kind, type, dateFrom, dateTo, value, uuid, components, base, basePeriod);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateCreditInterestRate {\n");
