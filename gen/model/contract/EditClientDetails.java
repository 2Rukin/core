...
@JsonTypeName("editClientDetails")
/**
 * DTO EditClientDetails.
 *
...
public class EditClientDetails {
   ...
   */
  public EditClientDetails(Long id, String name, String inn) {
    this.id = id;
    this.name = name;
    this.inn = inn;
  }

  public EditClientDetails id(Long id) {
    this.id = id;
    return this;
  }
  ...
  */
  ...
  public EditClientDetails name(String name) {
    this.name = name;
    return this;
  }
  ...
  */
  ...
  public EditClientDetails type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  */
  ...
  public EditClientDetails inn(String inn) {
    this.inn = inn;
    return this;
  }
  ...
  */
  ...
  public EditClientDetails kpp(String kpp) {
    this.kpp = kpp;
    return this;
  }
  ...
  */
  ...
  public EditClientDetails ogrn(String ogrn) {
    this.ogrn = ogrn;
    return this;
  }
  ...
  */
  ...
  public EditClientDetails registrationAddress(String registrationAddress) {
  ...
  */
  ...
  public EditClientDetails groupCompanyName(String groupCompanyName) {
  ...
  */
  ...
  public EditClientDetails groupCompanyComposition(String groupCompanyComposition) {
  ...
  */
  ...
  public EditClientDetails mspType(MspTypeEnum mspType) {
  ...
  */
  ...
  public EditClientDetails additionalInfo(String additionalInfo) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    EditClientDetails editClientDetails = (EditClientDetails) o;
    return Objects.equals(this.id, editClientDetails.id) &&
        Objects.equals(this.name, editClientDetails.name) &&
        Objects.equals(this.type, editClientDetails.type) &&
        Objects.equals(this.inn, editClientDetails.inn) &&
        Objects.equals(this.kpp, editClientDetails.kpp) &&
        Objects.equals(this.ogrn, editClientDetails.ogrn) &&
        Objects.equals(this.registrationAddress, editClientDetails.registrationAddress) &&
        Objects.equals(this.groupCompanyName, editClientDetails.groupCompanyName) &&
        Objects.equals(this.groupCompanyComposition, editClientDetails.groupCompanyComposition) &&
        Objects.equals(this.mspType, editClientDetails.mspType) &&
        Objects.equals(this.additionalInfo, editClientDetails.additionalInfo);
  }
  ...
  public String toString() {
    ...
    sb.append("class EditClientDetails {\n");
