...
@JsonTypeName("editCommissionPayment")
/**
 * DTO EditCommissionPayment.
 *
 * @author GPT-5.2-Codex
 */
@Data
@Builder
public class EditCommissionPayment {
  ...
  public EditCommissionPayment id(Long id) {
    this.id = id;
    return this;
  }
  ...
  */
  ...
  public EditCommissionPayment date(String date) {
    this.date = date;
    return this;
  }
  ...
  */
  ...
  public EditCommissionPayment amountType(AmountType amountType) {
  ...
  */
  ...
  public EditCommissionPayment amount(BigDecimal amount) {
    this.amount = amount;
    return this;
  }
  ...
  */
  ...
  public EditCommissionPayment percent(BigDecimal percent) {
  ...
  */
  ...
  public EditCommissionPayment percentOf(String percentOf) {
  ...
  */
  ...
  public EditCommissionPayment uuid(UUID uuid) {
    this.uuid = uuid;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    EditCommissionPayment editCommissionPayment = (EditCommissionPayment) o;
    return Objects.equals(this.id, editCommissionPayment.id) &&
        Objects.equals(this.date, editCommissionPayment.date) &&
        Objects.equals(this.amountType, editCommissionPayment.amountType) &&
        Objects.equals(this.amount, editCommissionPayment.amount) &&
        Objects.equals(this.percent, editCommissionPayment.percent) &&
        Objects.equals(this.percentOf, editCommissionPayment.percentOf) &&
        Objects.equals(this.uuid, editCommissionPayment.uuid);
  }
  ...
  public String toString() {
    ...
    sb.append("class EditCommissionPayment {\n");
