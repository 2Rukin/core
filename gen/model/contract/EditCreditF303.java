...
public class EditCreditF303 {
  ...
  public EditCreditF303 id(Long id) {
    this.id = id;
    return this;
  }
  ...
  */
  ...
  public EditCreditF303 limits(List<UUID> limits) {
    this.limits = limits;
    return this;
  }

  public EditCreditF303 addLimitsItem(UUID limitsItem) {
    if (this.limits == null) {
  ...
  */
  ...
  public EditCreditF303 creditType(List<F303CreditTypeItem> creditType) {
    this.creditType = creditType;
    return this;
  }

  public EditCreditF303 addCreditTypeItem(F303CreditTypeItem creditTypeItem) {
  ...
  */
  ...
  public EditCreditF303 creditPurpose(List<F303CreditPurposeItem> creditPurpose) {
    this.creditPurpose = creditPurpose;
    return this;
  }

  public EditCreditF303 addCreditPurposeItem(F303CreditPurposeItem creditPurposeItem) {
  ...
  */
  ...
  public EditCreditF303 interestRateType(List<F303InterestRateTypeItem> interestRateType) {
    this.interestRateType = interestRateType;
    return this;
  }

  public EditCreditF303 addInterestRateTypeItem(F303InterestRateTypeItem interestRateTypeItem) {
  ...
  */
  ...
  public EditCreditF303 interestPeriodPrevious(String interestPeriodPrevious) {
  ...
  */
  ...
  public EditCreditF303 changingComponentType(List<F303ChangingComponentTypeItem> changingComponentType) {
    this.changingComponentType = changingComponentType;
    return this;
  }

  public EditCreditF303 addChangingComponentTypeItem(F303ChangingComponentTypeItem changingComponentTypeItem) {
  ...
  */
  ...
  public EditCreditF303 periodMainPayment(List<F303PeriodMainPaymentItem> periodMainPayment) {
    this.periodMainPayment = periodMainPayment;
    return this;
  }

  public EditCreditF303 addPeriodMainPaymentItem(F303PeriodMainPaymentItem periodMainPaymentItem) {
  ...
  */
  ...
  public EditCreditF303 periodInterestPayment(List<F303PeriodInterestPaymentItem> periodInterestPayment) {
    this.periodInterestPayment = periodInterestPayment;
    return this;
  }

  public EditCreditF303 addPeriodInterestPaymentItem(F303PeriodInterestPaymentItem periodInterestPaymentItem) {
  ...
  */
  ...
  public EditCreditF303 paymentSource(List<F303PaymentSourceItem> paymentSource) {
    this.paymentSource = paymentSource;
    return this;
  }

  public EditCreditF303 addPaymentSourceItem(F303PaymentSourceItem paymentSourceItem) {
  ...
  */
  ...
  public EditCreditF303 specialConditionCode(List<F303SpecialConditionCodeItem> specialConditionCode) {
    this.specialConditionCode = specialConditionCode;
    return this;
  }

  public EditCreditF303 addSpecialConditionCodeItem(F303SpecialConditionCodeItem specialConditionCodeItem) {
  ...
  */
  ...
  public EditCreditF303 insuranceType(List<F303InsuranceTypeItem> insuranceType) {
    this.insuranceType = insuranceType;
    return this;
  }

  public EditCreditF303 addInsuranceTypeItem(F303InsuranceTypeItem insuranceTypeItem) {
  ...
  */
  ...
  public EditCreditF303 classification590P(List<F303classifications590PItem> classification590P) {
    this.classification590P = classification590P;
    return this;
  }

  public EditCreditF303 addClassification590PItem(F303classifications590PItem classification590PItem) {
  ...
  */
  ...
  public EditCreditF303 anotherClassification590p(String anotherClassification590p) {
  ...
  */
  ...
  public EditCreditF303 uuid(UUID uuid) {
    this.uuid = uuid;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    EditCreditF303 editCreditF303 = (EditCreditF303) o;
    return Objects.equals(this.id, editCreditF303.id) &&
        Objects.equals(this.limits, editCreditF303.limits) &&
        Objects.equals(this.creditType, editCreditF303.creditType) &&
        Objects.equals(this.creditPurpose, editCreditF303.creditPurpose) &&
        Objects.equals(this.interestRateType, editCreditF303.interestRateType) &&
        Objects.equals(this.interestPeriodPrevious, editCreditF303.interestPeriodPrevious) &&
        Objects.equals(this.changingComponentType, editCreditF303.changingComponentType) &&
        Objects.equals(this.periodMainPayment, editCreditF303.periodMainPayment) &&
        Objects.equals(this.periodInterestPayment, editCreditF303.periodInterestPayment) &&
        Objects.equals(this.paymentSource, editCreditF303.paymentSource) &&
        Objects.equals(this.specialConditionCode, editCreditF303.specialConditionCode) &&
        Objects.equals(this.insuranceType, editCreditF303.insuranceType) &&
        Objects.equals(this.classification590P, editCreditF303.classification590P) &&
        Objects.equals(this.anotherClassification590p, editCreditF303.anotherClassification590p) &&
        Objects.equals(this.uuid, editCreditF303.uuid);
  }
  ...
  public String toString() {
    ...
    sb.append("class EditCreditF303 {\n");
