...
import ru.domrf.elka.cdrd.contract_service.gen.model.contract.EditLimitCollateralMinPrice;
...
@JsonTypeName("editEscrowObject")
/**
 * DTO EditEscrowObject.
 *
 * @author GPT-5.2-Codex
 */
@Data
@Builder
public class EditEscrowObject {
  ...
  @Valid
  private List<@Valid EditLimitCollateralMinPrice> collateralMinPrices = new ArrayList<>();

  private UUID uuid;

  public EditEscrowObject id(Long id) {
    this.id = id;
    return this;
  }
  ...
  */
  ...
  public EditEscrowObject name(String name) {
    this.name = name;
    return this;
  }
  ...
  */
  ...
  public EditEscrowObject exploitationEntryDate(Long exploitationEntryDate) {
  ...
  */
  ...
  public EditEscrowObject investmentEndDate(String investmentEndDate) {
  ...
  */
  ...
  public EditEscrowObject collateralMinPrices(List<@Valid EditLimitCollateralMinPrice> collateralMinPrices) {
    this.collateralMinPrices = collateralMinPrices;
    return this;
  }

  public EditEscrowObject addCollateralMinPricesItem(EditLimitCollateralMinPrice collateralMinPricesItem) {
  ...
  */
  ...
  public List<@Valid EditLimitCollateralMinPrice> getCollateralMinPrices() {
    return collateralMinPrices;
  }

  public void setCollateralMinPrices(List<@Valid EditLimitCollateralMinPrice> collateralMinPrices) {
    this.collateralMinPrices = collateralMinPrices;
  }

  public EditEscrowObject uuid(UUID uuid) {
    this.uuid = uuid;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    EditEscrowObject editEscrowObject = (EditEscrowObject) o;
    return Objects.equals(this.id, editEscrowObject.id) &&
        Objects.equals(this.name, editEscrowObject.name) &&
        Objects.equals(this.exploitationEntryDate, editEscrowObject.exploitationEntryDate) &&
        Objects.equals(this.investmentEndDate, editEscrowObject.investmentEndDate) &&
        Objects.equals(this.collateralMinPrices, editEscrowObject.collateralMinPrices) &&
        Objects.equals(this.uuid, editEscrowObject.uuid);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, exploitationEntryDate, investmentEndDate, collateralMinPrices, uuid);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EditEscrowObject {\n");
