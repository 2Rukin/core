...
@JsonTypeName("getCreditSchedule")
/**
 * DTO GetCreditSchedule.
 *
 * @author GPT-5.2-Codex
 */
@Data
@Builder
public class GetCreditSchedule {
  ...
  public GetCreditSchedule id(Long id) {
    this.id = id;
    return this;
  }
  ...
  */
  ...
  public GetCreditSchedule limits(List<UUID> limits) {
    this.limits = limits;
    return this;
  }

  public GetCreditSchedule addLimitsItem(UUID limitsItem) {
    if (this.limits == null) {
  ...
  */
  ...
  public GetCreditSchedule schedule(List<@Valid GetPayment> schedule) {
    this.schedule = schedule;
    return this;
  }

  public GetCreditSchedule addScheduleItem(GetPayment scheduleItem) {
  ...
  */
  ...
  public GetCreditSchedule uuid(UUID uuid) {
    this.uuid = uuid;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    GetCreditSchedule getCreditSchedule = (GetCreditSchedule) o;
    return Objects.equals(this.id, getCreditSchedule.id) &&
        Objects.equals(this.limits, getCreditSchedule.limits) &&
        Objects.equals(this.schedule, getCreditSchedule.schedule) &&
        Objects.equals(this.uuid, getCreditSchedule.uuid);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetCreditSchedule {\n");
