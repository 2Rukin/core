...
import ru.domrf.elka.cdrd.contract_service.gen.model.contract.GetLimitCollateralMinPrice;
...
public class GetEscrowObject {
  ...
  @Valid
  private List<@Valid GetLimitCollateralMinPrice> collateralMinPrices = new ArrayList<>();

  private UUID uuid;

  public GetEscrowObject id(Long id) {
    this.id = id;
    return this;
  }
  ...
  */
  ...
  public GetEscrowObject name(String name) {
    this.name = name;
    return this;
  }
  ...
  */
  ...
  public GetEscrowObject exploitationEntryDate(Long exploitationEntryDate) {
  ...
  */
  ...
  public GetEscrowObject investmentEndDate(String investmentEndDate) {
  ...
  */
  ...
  public GetEscrowObject collateralMinPrices(List<@Valid GetLimitCollateralMinPrice> collateralMinPrices) {
    this.collateralMinPrices = collateralMinPrices;
    return this;
  }

  public GetEscrowObject addCollateralMinPricesItem(GetLimitCollateralMinPrice collateralMinPricesItem) {
  ...
  */
  ...
  public List<@Valid GetLimitCollateralMinPrice> getCollateralMinPrices() {
    return collateralMinPrices;
  }

  public void setCollateralMinPrices(List<@Valid GetLimitCollateralMinPrice> collateralMinPrices) {
    this.collateralMinPrices = collateralMinPrices;
  }

  public GetEscrowObject uuid(UUID uuid) {
    this.uuid = uuid;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    GetEscrowObject getEscrowObject = (GetEscrowObject) o;
    return Objects.equals(this.id, getEscrowObject.id) &&
        Objects.equals(this.name, getEscrowObject.name) &&
        Objects.equals(this.exploitationEntryDate, getEscrowObject.exploitationEntryDate) &&
        Objects.equals(this.investmentEndDate, getEscrowObject.investmentEndDate) &&
        Objects.equals(this.collateralMinPrices, getEscrowObject.collateralMinPrices) &&
        Objects.equals(this.uuid, getEscrowObject.uuid);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetEscrowObject {\n");
