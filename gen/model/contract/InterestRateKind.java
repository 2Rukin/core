...
public enum InterestRateKind {
  ...
  @JsonCreator
  public static InterestRateKind fromValue(String value) {
    for (InterestRateKind b : InterestRateKind.values()) {
